# Bilanz Ausfuhr Stuhlgang - MII IG ICU v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Bilanz Ausfuhr Stuhlgang**

## Example Observation: Bilanz Ausfuhr Stuhlgang
...
**code**: Enteral fluid loss (observable entity)
...
```json
{
  ...
  "id" : "mii-exa-icu-bilanz-ausfuhr-stuhlgang",
  "meta" : {
  ...
  "code" : {
    "coding" : [{
      ...
      "version" : "http://snomed.info/sct/900000000000207008/version/20241101",
      "code" : "251849009",
      "display" : "Enteral fluid loss (observable entity)"
    },
    {
