# Muv Herzzeitvolumen - MII IG ICU v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Muv Herzzeitvolumen**

## Example Observation: Muv Herzzeitvolumen
...
Profile: [SD MII ICU Herzzeitvolumen](https://simplifier.net/resolve?scope=de.gematik.isik@6.0.0&canonical=https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-herzzeitvolumen)
...
```json
{
  ...
  "id" : "mii-exa-icu-muv-herzzeitvolumen",
  "meta" : {
