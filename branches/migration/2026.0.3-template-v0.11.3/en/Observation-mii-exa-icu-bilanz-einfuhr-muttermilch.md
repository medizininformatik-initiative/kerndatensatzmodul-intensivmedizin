# Bilanz Einfuhr Muttermilch - MII IG ICU v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Bilanz Einfuhr Muttermilch**

## Example Observation: Bilanz Einfuhr Muttermilch
...
**code**: Measured volume of intake of breast milk (observable entity)
...
```json
{
  ...
  "id" : "mii-exa-icu-bilanz-einfuhr-muttermilch",
  "meta" : {
