# Muv Koerpertemperatur Halswirbelsaeule - MII IG ICU v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Muv Koerpertemperatur Halswirbelsaeule**

## Example Observation: Muv Koerpertemperatur Halswirbelsaeule
...
Profile: [SD MII ICU Koerpertemperatur Halswirbelsaeule](https://simplifier.net/resolve?scope=de.gematik.isik@6.0.0&canonical=https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-halswirbelsaeule)
...
```json
{
  ...
  "id" : "mii-exa-icu-muv-koerpertemperatur-halswirbelsaeule",
  "meta" : {
