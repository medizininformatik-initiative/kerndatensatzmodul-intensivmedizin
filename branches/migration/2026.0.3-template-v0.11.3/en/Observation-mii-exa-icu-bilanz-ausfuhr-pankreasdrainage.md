# Bilanz Ausfuhr Pankreasdrainage - MII IG ICU v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Bilanz Ausfuhr Pankreasdrainage**

## Example Observation: Bilanz Ausfuhr Pankreasdrainage
...
**code**: Volume of drainage of pancreatic fluid (observable entity)
...
```json
{
  ...
  "id" : "mii-exa-icu-bilanz-ausfuhr-pankreasdrainage",
  "meta" : {
