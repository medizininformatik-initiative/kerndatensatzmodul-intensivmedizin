# Muv Koerpertemperatur Rektal - MII IG ICU v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Muv Koerpertemperatur Rektal**

## Example Observation: Muv Koerpertemperatur Rektal
...
Profile: [SD MII ICU Koerpertemperatur rektal](https://simplifier.net/resolve?scope=de.gematik.isik@6.0.0&canonical=https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-rektal)
...
```json
{
  ...
  "id" : "mii-exa-icu-muv-koerpertemperatur-rektal",
  "meta" : {
