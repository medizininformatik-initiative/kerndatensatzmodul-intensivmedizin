# Bilanz Einfuhr Enterale Fluessigkeit - MII IG ICU v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **Bilanz Einfuhr Enterale Fluessigkeit**

## Beispiel Observation: Bilanz Einfuhr Enterale Fluessigkeit
...
**code**: Enteral fluid input (observable entity)
...
```json
{
  ...
  "id" : "mii-exa-icu-bilanz-einfuhr-enterale-fluessigkeit",
  "meta" : {
