...
**device**: [DeviceMetric/exa-mii-icu-vent-eingestellte-parameter-beatmung](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.org/packages/de.basisprofil.r4/DeviceMetric/exa-mii-icu-vent-eingestellte-parameter-beatmung)
