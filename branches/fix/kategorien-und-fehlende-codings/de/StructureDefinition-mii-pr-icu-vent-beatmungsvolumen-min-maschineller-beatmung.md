# MII PR ICU Beatmungsvolumen Pro Minute Maschineller Beatmung - MII IG ICU v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR ICU Beatmungsvolumen Pro Minute Maschineller Beatmung**

## Ressourcenprofil: MII PR ICU Beatmungsvolumen Pro Minute Maschineller Beatmung 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-vent-beatmungsvolumen-pro-minute-maschineller-beatmung | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_ICU_VENT_Beatmungsvolumen_Pro_Minute_Maschineller_Beatmung |
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-icu-vent-beatmungsvolumen-min-maschineller-beatmung.csv), [Excel](../StructureDefinition-mii-pr-icu-vent-beatmungsvolumen-min-maschineller-beatmung.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-vent-beatmungsvolumen-min-maschineller-beatmung.sch) 
...
```json
{
  ...
  "url" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-vent-beatmungsvolumen-pro-minute-maschineller-beatmung",
