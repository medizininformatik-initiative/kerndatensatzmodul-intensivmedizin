# MII PR ICU Score ICDSC - MII IG ICU v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR ICU Score ICDSC**

## Resource Profile: MII PR ICU Score ICDSC 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-score-icdsc | *Version*:2027.0.0-ballot.rc1 |
| Draft as of 2026-09-15 | *Computable Name*:MII_PR_ICU_Score_ICDSC |
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-score-icdsc.csv), [Excel](../StructureDefinition-mii-pr-icu-score-icdsc.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-score-icdsc.sch) 
