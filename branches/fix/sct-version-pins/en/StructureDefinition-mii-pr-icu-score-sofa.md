# MII PR ICU Score SOFA - MII IG ICU v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR ICU Score SOFA**

## Resource Profile: MII PR ICU Score SOFA 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-score-sofa | *Version*:2027.0.0-ballot.rc1 |
| Draft as of 2026-09-15 | *Computable Name*:MII_PR_ICU_Score_SOFA |
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-score-sofa.csv), [Excel](../StructureDefinition-mii-pr-icu-score-sofa.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-score-sofa.sch) 
