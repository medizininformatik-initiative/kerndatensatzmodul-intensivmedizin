# MII PR ICU Druckdifferenz Beatmung - MII IG ICU v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR ICU Druckdifferenz Beatmung**

## Resource Profile: MII PR ICU Druckdifferenz Beatmung 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-vent-druckdifferenz-beatmung | *Version*:2027.0.0-ballot.rc1 |
| Active as of 2026-09-15 | *Computable Name*:MII_PR_ICU_VENT_Druckdifferenz_Beatmung |

"Pressure difference ventilation" is a characteristic of the generic profile for [parameters of ventilation (Observation)](StructureDefinition-mii-pr-icu-parameter-von-beatmung.md). See there for more information regarding explanations of the items, or reference of the entries in the FHIR resource to the Logical Model. Pressure difference ventilation is defined by the delta of the upper (e.g. Pmax) and lower ventilation pressure (e.g. PEEP).
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-vent-druckdifferenz-beatmung.csv), [Excel](../StructureDefinition-mii-pr-icu-vent-druckdifferenz-beatmung.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-vent-druckdifferenz-beatmung.sch) 
