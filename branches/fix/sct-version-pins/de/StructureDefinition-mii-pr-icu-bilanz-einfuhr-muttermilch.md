# MII PR ICU Bilanz Einfuhr Muttermilch - MII IG ICU v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR ICU Bilanz Einfuhr Muttermilch**

## Ressourcenprofil: MII PR ICU Bilanz Einfuhr Muttermilch 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-bilanz-einfuhr-muttermilch | *Version*:2027.0.0-ballot.rc1 |
| Draft Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_ICU_Bilanz_Einfuhr_Muttermilch |
...
* Examples for this Profile: [Observation/mii-exa-icu-bilanz-einfuhr-muttermilch](Observation-mii-exa-icu-bilanz-einfuhr-muttermilch.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.icu|current/StructureDefinition/StructureDefinition-mii-pr-icu-bilanz-einfuhr-muttermilch.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-muttermilch.csv), [Excel](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-muttermilch.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-muttermilch.sch) 
