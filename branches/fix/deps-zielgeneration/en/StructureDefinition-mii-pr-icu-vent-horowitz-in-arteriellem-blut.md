# MII PR ICU Horowitz In Arteriellem Blut - MII IG ICU v2027.0.0-ballot.3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR ICU Horowitz In Arteriellem Blut**

## Resource Profile: MII PR ICU Horowitz In Arteriellem Blut 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-vent-horowitz-in-arteriellem-blut | *Version*:2027.0.0-ballot.3 |
| Active as of 2026-09-16 | *Computable Name*:MII_PR_ICU_VENT_Horowitz_In_Arteriellem_Blut |
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-vent-horowitz-in-arteriellem-blut.csv), [Excel](../StructureDefinition-mii-pr-icu-vent-horowitz-in-arteriellem-blut.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-vent-horowitz-in-arteriellem-blut.sch) 
