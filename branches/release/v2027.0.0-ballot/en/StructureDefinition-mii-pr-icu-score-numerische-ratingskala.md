# MII PR ICU Score Numerische Ratingskala - MII IG ICU v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR ICU Score Numerische Ratingskala**

## Resource Profile: MII PR ICU Score Numerische Ratingskala 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-score-numerische-ratingskala | *Version*:2027.0.0-ballot |
| Active as of 2026-09-14 | *Computable Name*:MII_PR_ICU_Score_Numerische_Ratingskala |
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-score-numerische-ratingskala.csv), [Excel](../StructureDefinition-mii-pr-icu-score-numerische-ratingskala.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-score-numerische-ratingskala.sch) 
