# MII Logical Model Intensivmedizin - MII IG ICU v2027.0.0-ballot.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII Logical Model Intensivmedizin**

## Logical Model: MII Logical Model Intensivmedizin 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/LogicalModel/Intensivmedizin | *Version*:2027.0.0-ballot.1 |
| Draft as of 2026-09-15 | *Computable Name*:MII_LM_ICU |
...
Other representations of profile: [CSV](../StructureDefinition-mii-lm-intensivmedizin.csv), [Excel](../StructureDefinition-mii-lm-intensivmedizin.xlsx) 
