# Vent Druckdifferenz Beatmung - MII IG ICU v2027.0.0-ballot.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Vent Druckdifferenz Beatmung**

## Example Observation: Vent Druckdifferenz Beatmung
...
Profile: [MII PR ICU Druckdifferenz Beatmung](StructureDefinition-mii-pr-icu-vent-druckdifferenz-beatmung.md)
...
**value**: 9.0 cm[H2O] (Details: UCUM codecm[H2O] = 'cm[H2O]')
...
```json
{
  ...
  "id" : "mii-exa-icu-vent-druckdifferenz-beatmung",
  "meta" : {
