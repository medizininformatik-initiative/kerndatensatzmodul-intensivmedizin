# MII PR ICU Bilanz Einfuhr Saeuglingsnahrung - MII IG ICU v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR ICU Bilanz Einfuhr Saeuglingsnahrung**

## Ressourcenprofil: MII PR ICU Bilanz Einfuhr Saeuglingsnahrung 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung | *Version*:2027.0.0-ballot.rc1 |
| Draft Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_ICU_Bilanz_Einfuhr_Saeuglingsnahrung |
...
* Examples for this Profile: [Observation/mii-exa-icu-bilanz-einfuhr-saeuglingsnahrung](Observation-mii-exa-icu-bilanz-einfuhr-saeuglingsnahrung.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.icu|current/StructureDefinition/StructureDefinition-mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung.csv), [Excel](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung.sch) 
