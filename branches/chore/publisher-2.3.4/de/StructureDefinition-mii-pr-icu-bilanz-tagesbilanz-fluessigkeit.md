# MII PR ICU Bilanz Tagesbilanz Fluessigkeit - MII IG ICU v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR ICU Bilanz Tagesbilanz Fluessigkeit**

## Ressourcenprofil: MII PR ICU Bilanz Tagesbilanz Fluessigkeit 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-bilanz-tagesbilanz-fluessigkeit | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_ICU_Bilanz_Tagesbilanz_Fluessigkeit |
...
* Examples for this Profile: [Observation/mii-exa-icu-bilanz-tagesbilanz-fluessigkeit](Observation-mii-exa-icu-bilanz-tagesbilanz-fluessigkeit.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.icu|current/StructureDefinition/StructureDefinition-mii-pr-icu-bilanz-tagesbilanz-fluessigkeit.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-icu-bilanz-tagesbilanz-fluessigkeit.csv), [Excel](../StructureDefinition-mii-pr-icu-bilanz-tagesbilanz-fluessigkeit.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-bilanz-tagesbilanz-fluessigkeit.sch) 
