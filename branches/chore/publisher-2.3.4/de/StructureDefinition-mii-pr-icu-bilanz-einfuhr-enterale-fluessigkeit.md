# MII PR ICU Bilanz Einfuhr Enterale Fluessigkeit - MII IG ICU v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR ICU Bilanz Einfuhr Enterale Fluessigkeit**

## Ressourcenprofil: MII PR ICU Bilanz Einfuhr Enterale Fluessigkeit 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit | *Version*:2027.0.0-ballot.rc1 |
| Active Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_ICU_Bilanz_Einfuhr_Enterale_Fluessigkeit |
...
* Examples for this Profile: [Observation/mii-exa-icu-bilanz-einfuhr-enterale-fluessigkeit](Observation-mii-exa-icu-bilanz-einfuhr-enterale-fluessigkeit.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.icu|current/StructureDefinition/StructureDefinition-mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit.csv), [Excel](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit.sch) 
