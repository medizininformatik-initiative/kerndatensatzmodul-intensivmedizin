# MII PR ICU Bilanz Einfuhr Spendermilch - MII IG ICU v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR ICU Bilanz Einfuhr Spendermilch**

## Ressourcenprofil: MII PR ICU Bilanz Einfuhr Spendermilch 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-bilanz-einfuhr-spendermilch | *Version*:2027.0.0-ballot.rc1 |
| Draft Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_ICU_Bilanz_Einfuhr_Spendermilch |
...
* Examples for this Profile: [Observation/mii-exa-icu-bilanz-einfuhr-spendermilch](Observation-mii-exa-icu-bilanz-einfuhr-spendermilch.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.icu|current/StructureDefinition/StructureDefinition-mii-pr-icu-bilanz-einfuhr-spendermilch.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-spendermilch.csv), [Excel](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-spendermilch.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-spendermilch.sch) 
