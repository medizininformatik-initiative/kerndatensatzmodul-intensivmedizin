...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-bilanz-ausfuhr-drainage-generisch | *Version*:2027.0.0-ballot.rc1 |
| Active as of 2026-09-15 | *Computable Name*:MII_PR_ICU_Bilanz_Ausfuhr_Drainage_Generisch |

"Balance export drainage generic (Observation)" is a characteristic of the generic profile for [(Liquid) balances (Observation)](StructureDefinition-mii-pr-icu-bilanz.md). See there for more detailed information regarding explanations of the items or reference of the entries in the FHIR resource to the Logical Model.
