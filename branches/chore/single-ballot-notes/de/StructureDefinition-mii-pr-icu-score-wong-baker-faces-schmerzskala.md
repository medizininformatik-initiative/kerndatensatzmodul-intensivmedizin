# MII PR ICU Score Wong-Baker-FACES-Schmerzskala - MII IG ICU v2027.0.0-ballot.1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR ICU Score Wong-Baker-FACES-Schmerzskala**

## Ressourcenprofil: MII PR ICU Score Wong-Baker-FACES-Schmerzskala 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-score-wong-baker-faces-schmerzskala | *Version*:2027.0.0-ballot.1 |
| Draft Stand: 2026-09-15 | *Maschinenlesbarer Name*:MII_PR_ICU_Score_Wong_Baker_Faces_Schmerzskala |
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-icu-score-wong-baker-faces-schmerzskala.csv), [Excel](../StructureDefinition-mii-pr-icu-score-wong-baker-faces-schmerzskala.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-score-wong-baker-faces-schmerzskala.sch) 
