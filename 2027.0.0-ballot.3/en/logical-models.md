# Logical Models - MII IG ICU v2027.0.0-ballot.3
...
[MII LM Intensivmedizin](StructureDefinition-mii-lm-intensivmedizin.md) — the conceptual dataset of the module (49 elements), independent of its concrete FHIR representation. The full rendering with detailed descriptions, mappings, XML and JSON views is on the artifact page; the element hierarchy:
