<!-- Harvested from https://simplifier.net/guide/MIIIGIntensivecare-EN/MIIIGModulICU/Technical-implementation?version=current on 2026-08-27 by scripts/guide-harvest.sh (spec 5.1d). -->
