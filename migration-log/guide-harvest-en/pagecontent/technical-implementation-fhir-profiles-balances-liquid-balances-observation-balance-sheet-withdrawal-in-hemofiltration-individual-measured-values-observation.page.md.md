<!-- Harvested from https://simplifier.net/guide/MIIIGIntensivecare-EN/MIIIGModulICU/Technical-implementation/FHIR-profiles/Balances/Liquid-balances-Observation/Balance-sheet-withdrawal-in-hemofiltration-individual-measured-values-Observation.page.md?version=current on 2026-08-27 by scripts/guide-harvest.sh (spec 5.1d). -->
...
#### Balance sheet withdrawal in hemofiltration individual measured values (Observation)
...
"Balance sheet withdrawal in hemofiltration individual measured values (Observation)" is a characteristic of the generic profile for [(Liquid) balances (Observation)](https://simplifier.net/guide/MIIIGIntensivecare-EN/MIIIGModulICU/Technical-implementation/FHIR-profiles/Balances/Liquid-balances-Observation?version=current). See there for more detailed information regarding explanations of the items or reference of the entries in the FHIR resource to the Logical Model.
