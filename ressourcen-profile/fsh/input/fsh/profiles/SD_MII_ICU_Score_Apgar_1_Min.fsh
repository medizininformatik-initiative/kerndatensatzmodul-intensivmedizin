Profile: SD_MII_ICU_Score_Apgar_1_Min
Parent: SD_MII_ICU_Score
Id: sd-mii-icu-score-apgar-1-min
Title: "SD MII ICU Score Apgar 1 Min"
* ^text.status = #empty
...
* component contains
    Hautfarbe 0..1 and
    Herzaktivitaet 0..1 and
    Absaugreflexe 0..1 and
    Muskeltonus 0..1 and
    Atmung 0..1
* component[Hautfarbe].code = $loinc#32406-1
...
* component[Hautfarbe].code.coding contains
    loinc 1..1 MS and
    snomed 1..1 MS
* component[Hautfarbe].code.coding[loinc] = $loinc#32406-1
...
* component[Herzaktivitaet].code = $loinc#32407-9
...
* component[Herzaktivitaet].code.coding[loinc] = $loinc#32407-9
...
* component[Absaugreflexe].code = $loinc#32409-5
...
* component[Absaugreflexe].code.coding contains
    loinc 1..1 MS and
    snomed 1..1 MS
* component[Absaugreflexe].code.coding[loinc] = $loinc#32409-5
...
* component[Muskeltonus].code = $loinc#32408-7
...
* component[Muskeltonus].code.coding contains
    loinc 1..1 MS and
    snomed 1..1 MS
* component[Muskeltonus].code.coding[loinc] = $loinc#32408-7
...
* component[Atmung].code = $loinc#32410-3
...
* component[Atmung].code.coding contains
    loinc 1..1 MS and
    snomed 1..1 MS
* component[Atmung].code.coding[loinc] = $loinc#32410-3
