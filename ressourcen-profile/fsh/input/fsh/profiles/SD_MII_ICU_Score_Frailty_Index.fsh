Profile: SD_MII_ICU_Score_Frailty_Index
Parent: SD_MII_ICU_Score
Id: sd-mii-icu-score-frailty-index
Title: "SD MII ICU Score Frailty Index"
* ^name = "SD_MII_ICU_Score_Frailty Index"
* ^text.status = #empty
* ^text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">No human-readable text provided in this case.</div>"
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/score-frailty-index"
* ^status = #draft
