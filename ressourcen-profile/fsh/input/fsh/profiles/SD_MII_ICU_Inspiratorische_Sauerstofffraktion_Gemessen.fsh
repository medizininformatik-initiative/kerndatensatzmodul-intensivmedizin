Profile: SD_MII_ICU_Inspiratorische_Sauerstofffraktion_Gemessen
Parent: SD_MII_ICU_Parameter_Von_Beatmung
Id: sd-mii-icu-inspiratorische-sauerstofffraktion-gemessen
Title: "SD MII ICU Inspiratorische Sauerstofffraktion Gemessen"
* ^text.status = #empty
