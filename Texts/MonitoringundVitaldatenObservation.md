...
Canonical: 
```https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Monitoring-und-Vitaldaten```

**Differential**

{{tree:https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Monitoring-und-Vitaldaten, diff}}
...
| Observation.subject <br><br> Observation.encounter | Patientenbezug  muss stets gegeben sein.|
...
| Observation.bodySite | Messort am Patienten. |
...
| Observation.dataAbsentReason[x]| **@Alex/@Felix: auch das einfach rauslassen? (nicht im Logical Model)**|
...
{{tree:https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Monitoring-und-Vitaldaten, snap}}

**Beispiel**

{{json:medizininformatikinitiative-modul-intensivmedizin/beispiel-monitoring-und-vitaldaten}}