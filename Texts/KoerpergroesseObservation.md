...
Canonical: 
```https://medizininformatik.org/fhir/ext/modul-icu/StructureDefinition/MII-Koerpergroesse```

**Differential**

{{tree:https://medizininformatik.org/fhir/ext/modul-icu/StructureDefinition/MII-Koerpergroesse, diff}}
...
{{tree:https://medizininformatik.org/fhir/ext/modul-icu/StructureDefinition/MII-Koerpergroesse, snap}}

**Beispiel**

{{json:medizininformatikinitiative-modul-intensivmedizin/koerpergroesse}}