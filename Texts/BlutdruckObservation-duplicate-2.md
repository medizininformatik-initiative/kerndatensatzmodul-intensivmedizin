...
Canonical: 
```https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Blutdruck```

**Differential**

{{tree:https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Blutdruck, diff}}


<br>

Siehe generisches Profil zu [Monitoring und Vitaldaten](https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Monitoring-und-Vitaldaten). Nachfolgend die **Unterschiede und Besonderheiten** für (Blut-)drücke im Vergleich zu den übrigen Vitaldaten. Diese Beschreibungen gelten so auch für die übrigen pulsatilen Drücke:
...
{{tree:https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Blutdruck, snap}}

**Beispiel**
Blutdruck
{{json:medizininformatikinitiative-modul-intensivmedizin/blutdruck-duplicate-2}}
