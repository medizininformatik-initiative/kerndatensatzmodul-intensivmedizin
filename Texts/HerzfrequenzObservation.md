...
Canonical: 
```https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Herzfrequenz```

**Differential**

{{tree:https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Herzfrequenz, diff}}
...
{{tree:https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Herzfrequenz, snap}}

**Beispiel**

{{json:medizininformatikinitiative-modul-intensivmedizin/herzfrequenzicu}}