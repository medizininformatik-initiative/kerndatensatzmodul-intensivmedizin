...
| Observation.device        | Intensivmedizin.Messmethode **@CHRISTOPH**|
...
{{tree:https://medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/MII-Parameter-von-extrakorporalen-Verfahren, snap}}

**Beispiel**

{{json:medizininformatikinitiative-modul-intensivmedizin/beispiel-parameter-von-extrakorporalen-verfahren}}