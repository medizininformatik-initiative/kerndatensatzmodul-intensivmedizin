...
Alias: $category-observation-bilanzen = https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/ValueSet/category-observation-bilanzen
...
* category.coding[kdsicu-category] from $category-observation-bilanzen (required)
* category.coding[kdsicu-category] ^patternCoding.system = "http://snomed.info/sct"
* category.coding[kdsicu-category].system 1.. MS
* category.coding[kdsicu-category].code 1.. MS
* category.coding[fixedCategoryBilanz] = $category-fixed#bilanz
