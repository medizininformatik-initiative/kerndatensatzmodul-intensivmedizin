...
<!-- DERIVED:no-source source=technischeimplementierung-fhir-profile-beatmungswerte-eingestellteundgemesseneparameterdevicemetric-duplicate-2.page.md.md gate=C -->
