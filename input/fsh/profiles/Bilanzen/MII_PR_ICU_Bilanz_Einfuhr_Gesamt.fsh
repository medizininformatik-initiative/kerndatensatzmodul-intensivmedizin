Profile: MII_PR_ICU_Bilanz_Einfuhr_Gesamt
Parent: MII_PR_ICU_Bilanz
Id: mii-pr-icu-bilanz-einfuhr-gesamt
Title: "MII PR ICU Bilanz Einfuhr Gesamt"
* insert PR_CS_VS_Version
* insert Publisher
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-bilanz-einfuhr-gesamt"
* ^status = #active
