...
* component[eye-assessment-possible-right-eye].valueBoolean 1..1
...
* component[eye-assessment-possible-left-eye].valueBoolean 1..1
...
* component[pupil-symmetry-base].valueCodeableConcept 1..1
...
* component[pupil-larger-eye].valueCodeableConcept 1..1
...
* component[pupil-size-right-eye].valueCodeableConcept 1..1
...
* component[pupil-size-left-eye].valueCodeableConcept 1..1
...
* component[pupil-shape-right-eye].valueCodeableConcept 1..1
...
* component[pupil-shape-left-eye].valueCodeableConcept 1..1
...
* component[direct-light-reflex-right-eye].valueBoolean 1..1
...
* component[direct-light-reflex-left-eye].valueBoolean 1..1
...
* component[consensual-light-reflex-right-eye].valueBoolean 1..1
...
* component[consensual-light-reflex-left-eye].valueBoolean 1..1

* ^constraint[+].key = "pupil-single-sym-1"
* ^constraint[=].severity = #error
* ^constraint[=].human = "Symmetry components only when both eyes assessable."
* ^constraint[=].expression = "((component.where(code.coding.code='eye-assessment-possible-right-eye').valueBoolean.where($this=true).count() + component.where(code.coding.code='eye-assessment-possible-left-eye').valueBoolean.where($this=true).count()) < 2) implies (component.where(code.coding.code='pupil-symmetry-base').empty() and component.where(code.coding.code='pupil-larger-eye').empty())"

* ^constraint[+].key = "pupil-single-sym-2"
* ^constraint[=].severity = #error
* ^constraint[=].human = "Symmetry base required when both eyes assessable."
* ^constraint[=].expression = "((component.where(code.coding.code='eye-assessment-possible-right-eye').valueBoolean.where($this=true).count() + component.where(code.coding.code='eye-assessment-possible-left-eye').valueBoolean.where($this=true).count()) = 2) implies component.where(code.coding.code='pupil-symmetry-base').exists()"

* ^constraint[+].key = "pupil-single-sym-3"
* ^constraint[=].severity = #error
* ^constraint[=].human = "Pupil larger eye must align with symmetry base."
* ^constraint[=].expression = "(component.where(code.coding.code='pupil-symmetry-base').valueCodeableConcept.coding.code = '13045009' implies component.where(code.coding.code='pupil-larger-eye').exists()) and (component.where(code.coding.code='pupil-symmetry-base').valueCodeableConcept.coding.code = '301943000' implies component.where(code.coding.code='pupil-larger-eye').empty())"

* ^constraint[+].key = "pupil-single-cons-1"
* ^constraint[=].severity = #error
* ^constraint[=].human = "Consensual light reflex only when both eyes assessable, and then for both eyes."
