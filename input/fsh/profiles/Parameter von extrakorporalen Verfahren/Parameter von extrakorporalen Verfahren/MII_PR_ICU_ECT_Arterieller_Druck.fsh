Profile: MII_PR_ICU_ECT_Arterieller_Druck
...
* insert Publisher
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-etc-arterieller-druck"
* ^status = #active
