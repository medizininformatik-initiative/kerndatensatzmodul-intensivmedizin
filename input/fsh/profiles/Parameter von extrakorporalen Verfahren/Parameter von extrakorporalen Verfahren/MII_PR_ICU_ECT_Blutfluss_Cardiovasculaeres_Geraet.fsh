Profile: MII_PR_ICU_ECT_Blutfluss_Cardiovasculaeres_Geraet
...
* insert Publisher
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/mii-pr-icu-etc-blutfluss-cardiovasculaeres-geraet"
* ^status = #active
