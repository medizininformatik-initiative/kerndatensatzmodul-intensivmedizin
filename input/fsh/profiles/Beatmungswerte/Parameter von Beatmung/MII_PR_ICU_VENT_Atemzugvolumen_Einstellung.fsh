...
* code.coding[sct] ^patternCoding.display = "Tidal volume setting (observable entity)"
* code.coding[loinc] 1..1
* code.coding[loinc] ^patternCoding.code = #20112-9
* code.coding[loinc] ^patternCoding.display = "Tidal volume setting Ventilator"
* code.coding[IEEE-11073] 1..1
* code.coding[IEEE-11073] ^patternCoding.code = #16929196
* code.coding[IEEE-11073] ^patternCoding.display = "MDC_VENT_VOL_TIDAL_SETTING"
