Profile: SD_MII_ICU_Score_Apgar_10_Min
Parent: SD_MII_ICU_Score
Id: sd-mii-icu-score-apgar-10-min
Title: "SD MII ICU Score Apgar 10 Min"
* ^text.status = #empty
* ^text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">No human-readable text provided in this case.</div>"
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/score-apgar-10-min"
* ^status = #draft
...
* component[Hautfarbe].code.coding contains
    loinc 1..1 MS and
    snomed 1..1 MS
* component[Hautfarbe].code.coding[loinc] = $loinc#32401-2
...
* component[Herzaktivitaet].code.coding[loinc] = $loinc#32402-0
...
* component[Absaugreflexe].code.coding contains
    loinc 1..1 MS and
    snomed 1..1 MS
* component[Absaugreflexe].code.coding[loinc] = $loinc#32404-6
...
* component[Muskeltonus].code.coding contains
    loinc 1..1 MS and
    snomed 1..1 MS
* component[Muskeltonus].code.coding[loinc] = $loinc#32403-8
...
* component[Atmung].code.coding contains
    loinc 1..1 MS and
    snomed 1..1 MS
* component[Atmung].code.coding[loinc] = $loinc#32405-3
