Profile: SD_MII_ICU_Score_Glasgow_Coma
Parent: SD_MII_ICU_Score
Id: sd-mii-icu-score-glasgow-coma
Title: "SD MII ICU Score Glasgow Coma"
* ^text.status = #empty
* ^text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">No human-readable text provided in this case.</div>"
* ^url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-icu/StructureDefinition/score-glasgow-coma"
* ^status = #draft
