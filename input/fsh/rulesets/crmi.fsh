...
//   "2019+ Medical Informatics Initiative (MII)" → "2023+ …"
...
// basis); pass 2026-08-27 / C201962 at the call site.
// ─────────────────────────────────────────────────────────────────────────────
...
* ^extension[=].valueString = "2023+ Medical Informatics Initiative (MII)"
...
//   insert CRMIArtifactTopic(http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl, C201962)
