...
* MonitoringUndVitaldaten 0..* BackboneElement "Allgemeine Gruppe für die Überwachungs- und Messdaten der mit dem Patienten verbundenen Geräte, insbesondere Vitaldaten und Beatmungswerte, aber auch z.B. die 24h-Flüssigkeitsbilanz. Hinweis: Blutgaswerte werden wie Laborwerte behandelt."
  ...
  * Parameter.ParameterCode 0..* http://hl7.org/fhir/StructureDefinition/string "Semantische Annotation. Primärcodes (mindestens einer sollte immer vorhanden sein): LOINC, SNOMED CT, Arzneimittel-Stoffkatalog-Nummer (ASK). Sekundärcodes (sollten vorhanden sein, wenn zutreffend):  ISO/IEEE 11073-10101 ( BMBF-Projekt OR.NET 1), DIVI Kerndatensatz Intensivmedizin (2010) 2, ggf. Referenz DIVI-Register Intensivmedizin, AKTIN-Codierung/Referenz 3, ggf. Referenz Kerndatensatz Anästhesiologie, ggf. Referenz MPOG"
  * Parameter.ParameterName 0..* http://hl7.org/fhir/StructureDefinition/string "Parametername wie z.B. Herzfrequenz oder Pulsfrequenz"
  ...
  * Referenzbereich.Typ 0..* http://hl7.org/fhir/StructureDefinition/string "Typ des Referenzbereichs"
  * Referenzbereich.Obergrenze 0..* http://hl7.org/fhir/StructureDefinition/string "Obergrenze des Referenzbereichs (optional, bei Referenzbereichen ohne Obergrenze)"
  * Referenzbereich.Untergrenze 0..* http://hl7.org/fhir/StructureDefinition/string "Untergrenze des Referenzbereichs (optional, bei Referenzbereichen ohne Untergrenze)"
...
* Beatmungswerte 0..* BackboneElement "Strukturelement. In der untergeordneten Struktur sind alle Daten modiliert, die im Rahmen eines extrakorporalen Verfahrens anfallen."
  ...
  * Atemweg.AtemwegName 0..* http://hl7.org/fhir/StructureDefinition/string "Bezeichnung des Atemweges z.B. \"Endotracheal tube\""
  ...
  * Atemweg.KlinischRelevanteZeit 0..* contentReference #Intensivmedizin.KlinischRelevanteZeit "Siehe Intensivmedizin.KlinischRelevanteZeit"
  * Beatmungsart 0..* BackboneElement "Art bzw. Bezeichnung der Beatmung"
  * Beatmungsart.BeatmungsartName 0..* http://hl7.org/fhir/StructureDefinition/string "Name bzw. Bezeichnung der Beatmungsmethode"
  * Beatmungsart.BeatmungsartCode 0..* http://hl7.org/fhir/StructureDefinition/string "Semantische Annotation. Primärcodes (mindestens einer sollte immer vorhanden sein): LOINC, SNOMED CT, Arzneimittel-Stoffkatalog-Nummer (ASK). Sekundärcodes (sollten vorhanden sein, wenn zutreffend):  ISO/IEEE 11073-10101 ( BMBF-Projekt OR.NET 1), DIVI Kerndatensatz Intensivmedizin (2010) 2, ggf. Referenz DIVI-Register Intensivmedizin, AKTIN-Codierung/Referenz 3, ggf. Referenz Kerndatensatz Anästhesiologie, ggf. Referenz MPOG"
  * Beatmungsart.KlinischRelevanteZeit 0..* contentReference #Intensivmedizin.KlinischRelevanteZeit "Siehe Intensivmedizin.KlinischRelevanteZeit"
* Messmethode 0..* BackboneElement "Methode der Messung"
  ...
  * Geraet.Geraetebezeichnung 0..* http://hl7.org/fhir/StructureDefinition/string "Bezeichnung ggf. Handelsname des medizinischen Gerätes"
  * Geraet.Geraeteversion 0..* http://hl7.org/fhir/StructureDefinition/string "Version des Gerätebezeichners z.B. Firmware-Version"
  * Geraet.Geraetekonfiguration 0..* http://hl7.org/fhir/StructureDefinition/string "Version des Gerätebezeichners z.B. Firmware-Version"
