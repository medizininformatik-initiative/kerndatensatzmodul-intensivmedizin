ValueSet: MII_VS_ICU_Code_Observation_extrakorporale_Verfahren_LOINC
...
* include $loinc#83064-6 "Calcium.ionized [Moles/volume] in Blood drawn from CRRT circuit"
* include $loinc#19941-4 "Oxygen gas flow Oxygen delivery system"