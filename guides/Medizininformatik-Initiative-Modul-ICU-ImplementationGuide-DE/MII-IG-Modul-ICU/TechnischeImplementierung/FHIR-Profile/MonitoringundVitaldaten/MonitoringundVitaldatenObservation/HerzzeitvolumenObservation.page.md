---
topic: HerzzeitvolumenObservation
---
#### {{page-title}}
...
{{tree:https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-herzzeitvolumen, diff}}

---

**Snapshot**

{{tree:https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-herzzeitvolumen, snap}}

**Beispiel**

{{json:medizininformatikinitiative-modul-intensivmedizin/exa-mii-icu-muv-herzzeitvolumen}}