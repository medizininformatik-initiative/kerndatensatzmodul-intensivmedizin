---
topic: EingestellteundgemesseneParameterDeviceMetric-duplicate-2
---
#### {{page-title}}
...
1. The device is **not known and cannot be modelled** and the device is **known and cannot/should not be modelled**.
...
{{json:medizininformatikinitiative-modul-intensivmedizin/exa-mii-icu-vent-eingestellte-parameter-beatmung}}

Gemessen

{{json:medizininformatikinitiative-modul-intensivmedizin/exa-mii-icu-vent-gemessene-parameter-beatmung}}